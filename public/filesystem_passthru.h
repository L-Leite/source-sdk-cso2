...
public:
	...
	virtual bool			AddPackFile( const char *fullpath, const char *pathID )								{ return nullptr; /*m_pFileSystemPassThru->AddPackFile( fullpath, pathID );*/ }
	...
	virtual bool			FileSystem38( char* a2 ) { m_pFileSystemPassThru->FileSystem38( a2 ); }
